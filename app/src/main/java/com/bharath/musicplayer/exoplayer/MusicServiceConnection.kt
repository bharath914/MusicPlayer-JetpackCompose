...
import com.bharath.musicplayer.other.Event
import com.bharath.musicplayer.other.Resource
...
class MusicServiceConnection(
    ...
    private val _playBackState =
        MutableStateFlow<PlaybackStateCompat?>(PlaybackStateCompat.Builder().build())
    val playBackState: StateFlow<PlaybackStateCompat?> = _playBackState


    private val _curPlayingSong =
        MutableStateFlow<MediaMetadataCompat?>(MediaMetadataCompat.Builder().build())
